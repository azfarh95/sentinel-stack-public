-- Register phone-vision-mcp (Sentinel AI Mobile `phone.vision`) into metamcp's
-- default namespace so Dove/OpenClaw can call it. Mirrors register_translate.sql.
-- Reached over the docker network by service name; FastMCP serves MCP at /mcp.
BEGIN;

INSERT INTO mcp_servers (uuid, name, type, url)
VALUES ('00000000-0000-0000-0000-000000008100', 'phone-vision-mcp', 'STREAMABLE_HTTP', 'http://phone-vision-mcp:8100/mcp')
...
SELECT '0a83b85b-24ea-4491-b24b-17104bc9bba0',
       (SELECT uuid FROM mcp_servers WHERE name = 'phone-vision-mcp' AND user_id IS NULL),
       'ACTIVE'
