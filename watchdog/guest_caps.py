...
# V6 prep: source paths from the central _paths module
import sys as _sys
_sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
from _paths import (  # noqa: E402
    SESSIONS_JSON as _SESSIONS_JSON_PATH,
    TELEGRAM_ALLOWFROM as _ALLOW_FROM_PATH,
)

SESSIONS_JSON = str(_SESSIONS_JSON_PATH)
ALLOW_FROM_JSON = str(_ALLOW_FROM_PATH)
