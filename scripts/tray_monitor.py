...
CRIB_DIR = (
    r"C:\Users\azfar\.docker\cagent\working_directories"
    r"\docker-gordon-v7\6f9243c0-aab4-4c98-b86b-d0132dc9bebf\default\crib-watchdog"
)
...
if __name__ == "__main__":
    ...
    _log = pathlib.Path(r"C:\Users\azfar\metamcp-local\scripts\tray_monitor.log")
    try:
        main()
    except Exception:
