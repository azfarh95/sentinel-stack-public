...
CHAT_ID    = _cfg.get("telegram_chat_ids", {}).get("group", "-1003748374568")
OWNER_ID   = int(_cfg.get("telegram_chat_ids", {}).get("dm", "YOUR_TELEGRAM_CHAT_ID"))
...
CONFIG_FILE      = r"C:\Users\azfar\metamcp-local\sentinel_config.json"
