...
async def browser_task(goal: str, mode: str = "headless",
    ...
    Args:
      ...
      mode    "headless" (isolated throwaway Chrome, default) | "comet" (attach the
              owner's live Comet via CDP — only if it's running with remote debugging) |
              "stealth" (camofox anti-detection Firefox — for targets that block headless
              Chrome or need the clean proxied IP; ADR MED-012).
